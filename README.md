...
| <a name="input_azuredevops"></a> [azuredevops](#input\_azuredevops) | Azure DevOps configuration | <pre>object({<br/>    service_connection_name = string<br/>    repository_name         = string<br/>  })</pre> | `null` | no |
